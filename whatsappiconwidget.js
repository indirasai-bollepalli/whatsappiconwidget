    ...
    <div>
      ...
      class whatsappiconwidgetWidget extends HTMLElement {
          ...
          async initMain() {
            ...
            let url = this._props.url; // use default URL if not set
          ...
          async onClick() {
            let url = `https://api.whatsapp.com/send?phone=${this._props.number}&text=${encodeURIComponent(this._props.url)}`;
